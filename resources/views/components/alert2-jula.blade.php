...
<div class="alert flex flex-row items-center bg-{{$color}}-200 p-5 rounded border-b-2 border-red-300">
	<div class="alert-icon flex items-center bg-{{$color}}-100 border-2 border-{{$color}}-500 justify-center h-10 w-10 flex-shrink-0 rounded-full">
	...
	<div class="alert-content ml-4">
		<div class="alert-title font-semibold text-lg text-{{$color}}-800">
			{{$titulo}}
		</div>
